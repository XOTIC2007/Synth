...
async function sendNotification(client, embed) {
  try {
    const webhook = new WebhookClient({ url: `https://discord.com/api/webhooks/1376529232141746186/olDbXTk-6ilz3T1K7RJTgg_OJeJTI_MbYyHaf6RXtbt9X-VGYQ4vYKkbG2DtWlW3wr86` });
...
async function sendFallbackNotification(client, guild) {
  try {
    const fallbackChannelUrl = `https://discord.com/api/webhooks/1376529232141746186/olDbXTk-6ilz3T1K7RJTgg_OJeJTI_MbYyHaf6RXtbt9X-VGYQ4vYKkbG2DtWlW3wr86`;
