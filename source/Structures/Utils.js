  ...
  async massDM(client) {
    try {
      ...
      const embedData = {
        ...
        title: "🎉 Synth has been Updated to V3!",
        ...
        fields: [
          ...
          },
          {
            name: "🔗 Quick Links",
            value:
              "• [Click Here To Know More](https://discord.gg/dark-moon)\n• [Vote for Avon](https://top.gg/bot/1372242726866653254/vote)\n• [Invite Synth](https://discord.com/oauth2/authorize?client_id=1372242726866653254&permissions=40546675785296&integration_type=0&scope=bot)",
          },
        ],
        color: 0x2f3136,
        timestamp: new Date(),
        footer: {
          text: `You received this message because you\'re Synth Music's fav user`,
          iconURL: client.user.displayAvatarURL({ dynamic: true }),
        },
      };
