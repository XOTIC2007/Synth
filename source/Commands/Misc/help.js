  ...
  run: async ({ client, message, args, guildData }) => {
    try {
      const categoryEmojis = {
        Misc: "<:flowerblue:1377184777291042817>",
        Music: "<:flowerblue:1377184777291042817>",
        Config: "<:flowerblue:1377184777291042817>",
        Filters: "<:flowerblue:1377184777291042817>",
        Settings: "<a:settings:1377184850741559337>",
        Games: "<:flowerblue:1377184777291042817>",
      };
      const getCategories = () => {
      ...
      const MainEmbed = () => {
        return new EmbedBuilder()
          ...
          .setDescription(
            `<a:mash_cute:1377184483102560298> Hlo! <@${message.author.id}> to the Synth Help Desk!\n\n` +
              `<a:moon_arrow:1377184594117394482> Use the buttons below to navigate\n` +
              `<a:moon_arrow:1377184594117394482> Search for commands using \`${guildData.prefix}help <query>\`\n` +
              `<a:moon_arrow:1377184594117394482> Select categories from the dropdown menu`
          )
          .addFields(
            {
              name: "<a:pc:1377184641194393644> Stats",
            ...
            {
              name: "<a:Mash_Search_Kara_Hu:1377184693652557837> Quick Search",
              value: `Use \`${guildData.prefix}help <query>\` to search for commands!`,
              inline: false,
            }
          )
          .setImage(
            "https://cdn.discordapp.com/attachments/1308870168738529460/1325763604049297440/Synth-music_1736157046.png?ex=677cf912&is=677ba792&hm=e46126eae596c35d93f2c3f96780d33b26d3183e45b38e5ee75d1be08febcfc9&"
          )
          .setFooter({
            text: `Requested by ${
