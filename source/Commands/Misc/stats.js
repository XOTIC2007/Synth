...
@for support join https://discord.gg/dark-moonmoonmoon
**/
...
module.exports = {
  ...
  run: async ({ client, message }) => {
    try {
      ...
      const embed1 = createEmbed("Bot Statistics", "Detailed information about the bot's current status and performance.", [
        {
          name: "General Stats",
          value: `\`\`\`yaml
...
\`\`\``,
      ...
      const embed2 = createEmbed("Shard Information", "Detailed information about the current shard and clustering.", [
        {
          name: "Shard Details",
          value: `\`\`\`yaml
...
\`\`\``,
      ...
      const embed3 = createEmbed("System Information", "Detailed information about the host system.", [
        {
          name: "System Details",
          value: `\`\`\`yaml
OS Type     : ${os.type()}
...
\`\`\``,
      ...
      const embed4 = createEmbed("Developers Information", 
        `- <a:mash_drum:1377185095810814067> [**XOTIC**](https://discord.com/users/745298312240038039)\n- <a:mash_drum:1377185095810814067> [**ITACHI**](https://discord.com/users/1259377339842691219)\n- <a:mash_drum:1377185095810814067> [**GOJO**](https://discord.com/users/1298348053648117761)\n- <a:mash_drum:1377185095810814067> [**REDMONK**](https://discord.com/users/1204524047505825802)`
      );

      const createButton = (id, label, emoji = null, disabled = false) => {
